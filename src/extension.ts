...
function runPythonCLI(context: vscode.ExtensionContext, args: string[]): Promise<string> {
...
export function activate(context: vscode.ExtensionContext) {
    ...
    let disposableExtract = vscode.commands.registerCommand('e2studio.extractVariable', async (agentVarName?: string) => {
